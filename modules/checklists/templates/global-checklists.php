<form method="post" id="pp-checklists-global">
    ...
    <table class="wp-list-table striped pp-checklists-requirements-settings" id="pp-checklists-requirements">
        ...
        <tr>
            <th><?php
                echo $context['lang']['description']; ?></th>
            <th><?php
                echo $context['lang']['action']; ?></th>
            <?php
            /**
             * @param string $html
             * @param $requirement
            ...
            ?>
            <th><?php
                echo $context['lang']['post_status']; ?></th>
            <th><?php
                echo $context['lang']['params']; ?></th>
        </tr>
        </thead>
        ...
        foreach ($context['requirements'] as $post_type => $post_type_requirements) : ?>
            ...
            foreach ($post_type_requirements as $requirement) : ?>
                <tr
                    ...
                    <td><?php
                        echo $requirement->get_setting_title_html(); ?></td>
                    <td><?php
                        echo $requirement->get_setting_action_list_html(); ?></td>
                    <?php
                    /**
                     * @param string $html
                     * @param $requirement
                    ...
                    <td class="pp-checklists-post-status">
                        <?php
                        echo $requirement->get_setting_post_status_html(); ?>
                    </td>
    ...
    <div>
        <a id="pp-checklists-add-button" href="javascript:void(0);" class="button button-secondary">
            ...
            echo $context['lang']['add_custom_item']; ?>
        </a>
        <span class="pp-checklists-field-description"><?php
            echo __(
                'Custom tasks do not complete automatically. Users must check the box to show they have completed the task.',
    ...
    <input type="submit" name="submit" id="submit" class="button button-primary"
           value="<?php
           echo __('Save Changes', 'publishpress-checklists'); ?>">
</form>
