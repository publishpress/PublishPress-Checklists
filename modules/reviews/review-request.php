...
class Ppch_Modules_Reviews {
	...
	public static function admin_notices() {
		...
		<div class="notice notice-success is-dismissible ppch-notice">
			...
			<p>
                <a class="button button-primary ppch-dismiss" target="_blank" href="https://wordpress.org/support/plugin/publishpress-checklists/reviews/?rate=5#rate-response" data-reason="am_now">
