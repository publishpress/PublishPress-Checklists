...
class Base_requirement
{
    ...
    {
        add_action('pp_checklist_load_requirements', [$this, 'init'], static::PRIORITY);
    ...
    {
        add_filter('pp_checklist_requirements_default_options', [$this, 'filter_default_options']);
        add_filter('pp_checklist_validate_requirement_settings', [$this, 'filter_settings_validate']);
        add_filter('pp_checklist_requirement_list', [$this, 'filter_requirements_list'], 10, 3);
        add_filter('pp_checklist_requirement_instances', [$this, 'filter_requirement_instances'], 10, 4);
