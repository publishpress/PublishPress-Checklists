...
class Taxonomies_count extends Base_counter implements Interface_parametrized
{
    ...
    public function init_language()
    {
        ...
        $this->lang['label_settings']       = __('Number of ', 'publishpress-content-checklist') . $label;
        $this->lang['label_min_singular']   = __('Minimum of %s ', 'publishpress-content-checklist') . $singular_label;
        $this->lang['label_min_plural']     = __('Minimum of %s ', 'publishpress-content-checklist') . $label;
        $this->lang['label_max_singular']   = __('Maximum of %s ', 'publishpress-content-checklist') . $singular_label;
        $this->lang['label_max_plural']     = __('Maximum of %s ', 'publishpress-content-checklist') . $label;
        $this->lang['label_exact_singular'] = __('%s ', 'publishpress-content-checklist') . $singular_label;
        $this->lang['label_exact_plural']   = __('%s ', 'publishpress-content-checklist') . $label;
        $this->lang['label_between']        = __('Between %s and %s ', 'publishpress-content-checklist') . $label;
    }
