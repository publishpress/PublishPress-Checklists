...
if ( ! file_exists($publishpressPath) || is_plugin_inactive('publishpress/publishpress.php')) {
    function pp_checklist_admin_error()
    {
        ...
        <div class="notice notice-error is-dismissible">
            Please, install and activate the <a href="https://wordpress.org/plugins/publishpress" target="_blank">PublishPress</a></strong>
            plugin in order to make <em>PublishPress Content Checklist</em> work.</p>
        </div>
        <?php
    }
...
if ( ! defined(PP_HALT_CONSTANT) && ! defined('PP_CONTENT_CHECKLIST_LOADED')) {
    ...
    if ( ! defined('PP_CONTENT_CHECKLIST_MIN_PARENT_VERSION')) {
        define('PP_CONTENT_CHECKLIST_MIN_PARENT_VERSION', '1.20.0');
    }
    ...
    if (version_compare(PUBLISHPRESS_VERSION, PP_CONTENT_CHECKLIST_MIN_PARENT_VERSION, '<')) {
        function pp_checklist_admin_version_error()
        {
            ?>
            <div class="notice notice-error is-dismissible">
                Sorry, PublishPress Content Checklist requires <a href="https://wordpress.org/plugins/publishpress"
                                                                  target="_blank">PublishPress</a></strong>
                version <?php echo PP_CONTENT_CHECKLIST_MIN_PARENT_VERSION; ?> or later.</p>
            </div>
            <?php
        }
    ...
    if ( ! defined(PP_HALT_CONSTANT)) {
        ...
        define('PUBLISHPRESS_CONTENT_CHECKLIST_VERSION', '1.4.6-dev');
